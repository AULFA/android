...
public final class MainCatalogActivity extends CatalogFeedActivity
{
  ...
  protected void onCreate(Bundle state) {
    ...
    if (netInfo != null && netInfo.isConnected() && this.isAwaitingDownload()) {
