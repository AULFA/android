...
public interface ProfilesControllerType {
   ...
   *
   * @param id The profile ID
   * @return A future that returns a deletion event
   */

  ListenableFuture<ProfileDeletionEvent> profileDelete(
    ProfileID id);
  ...
  ListenableFuture<ProfilePreferencesChanged> profileDisplayNameUpdateFor(
    ProfileID profile,
    String displayName);
